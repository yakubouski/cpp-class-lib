...
namespace c {
	namespace mm {
		...
		//---------------------------------------------------------------------
		static forceinline void memcpy_sse2_16(void* dst, const void* src) {
			__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
			_mm_storeu_si128(((__m128i*)dst) + 0, m0);
		}

		static forceinline void memcpy_sse2_32(void* dst, const void* src) {
			__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
		...
		static forceinline void memcpy_sse2_64(void* dst, const void* src) {
			__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
			__m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
		...
		static forceinline void memcpy_sse2_128(void* dst, const void* src) {
			__m128i m0 = _mm_loadu_si128(((const __m128i*)src) + 0);
			__m128i m1 = _mm_loadu_si128(((const __m128i*)src) + 1);
			__m128i m2 = _mm_loadu_si128(((const __m128i*)src) + 2);
			__m128i m3 = _mm_loadu_si128(((const __m128i*)src) + 3);
		...
		//---------------------------------------------------------------------
		static forceinline void* memcpy_tiny(void* dst, const void* src, size_t size) {
		...
		// main routine
		//---------------------------------------------------------------------
		static forceinline void* memcpy_fast(void* destination, const void* source, size_t size)
		{
	...
	static forceinline void* memcpy(void* destination, const void* source, size_t size) {
		return c::mm::memcpy_fast(destination, source, size);
	}
}