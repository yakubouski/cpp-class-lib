...
ini::ini() : head(nullptr) { ; }
ini& ini::operator = (ini&& cfg) { head.swap(cfg.head); return *this; }

inline ini::csection* ini::get_section(list<string>& path) {
...
ini::ini(const string configfile) : head(new csection()) {
